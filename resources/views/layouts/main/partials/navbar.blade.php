<div class="app-navbar flex-shrink-0">
    ...
    <div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
        ...
        <div class="cursor-pointer symbol symbol-35px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
            ...
            <img src="{{ auth()->user()->image_full_url }}" class="rounded-3" alt="user" />
        </div>
            ...
            <div class="menu-item px-3">
                <div class="menu-content d-flex align-items-center px-3">
                    ...
                    <div class="symbol symbol-50px me-5">
                        <img src="{{ auth()->user()->image_full_url }}" alt="" />
                    </div>
                    <!--end::Avatar-->
                    <!--begin::Username-->
            ...
            <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                ...
                <div class="menu-sub menu-sub-dropdown w-175px py-4">
                    @foreach (config('languages') as $language)
                        <div class="menu-item px-3">
                            <a href="{{ route('language.switch', $language['id']) }}"
                                class="menu-link d-flex px-5 {{ $language['id'] === app()->getLocale() ? 'active' : '' }}">
                                <span class="symbol symbol-20px me-4">
                                    <img class="rounded-1" src="{{ asset($language['flag_image_url']) }}"
                                        alt="" />
                                </span>
                                {{ $language['name'] }}
                            </a>
