<?php
$title = __('Create :name', ['name' => __('Unit of Measurement')]);
$breadcrumbs = [
    [
        ...
        <div class="card mb-8 mb-xl-10">
            <div class="card-header border-0">
                <div class="card-title m-0">
                    <h3 class="fw-bold m-0">{{ __('Create :name', ['name' => __('Unit of Measurement')]) }}</h3>
                </div>
            </div>

            <form id="form" onsubmit="return false" novalidate="novalidate" class="form"
                data-url-action="{{ route('unit-of-measurements.store') }}">
                @method('POST')
                ...
                <div class="card-body border-top p-9">
                    ...
                    <div class="row">
                        <div class="col-sm-12 mb-10 fv-row">
                            <label for="name"
                                class="fs-6 fw-semibold form-label required">{{ __('Name') }}</label>
